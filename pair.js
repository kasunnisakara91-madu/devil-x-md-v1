...
const config = {
  ...
  OTP_EXPIRY: 300000,
  OWNER_NUMBER: process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(',') : ['94743387798'],
...
const MONGO_DB = process.env.MONGO_DB || 'KEZU1';
...
case 'm': {
    ...
    const API_KEY = "chama_api_70bcd9070d5c948bcf80f86b22435f01"; // ඔබේ API Key එක දාන්න
